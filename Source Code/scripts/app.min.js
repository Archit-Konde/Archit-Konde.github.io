...
{ icon: '↗', label: 'View SupportOps Demo', hint: 'HuggingFace', action() { window.open('https:
{ icon: './', label: 'View GitHub', hint: 'github.com', action() { window.open('https:
{ icon: 'in', label: 'View LinkedIn', hint: 'linkedin.com', action() { window.open('https:
];
const homeCommands = [
